...
const FIRE = { usp: 'usp_01', glock: 'usp_01', duals: 'usp_01', deagle: 'deagle_01', r8: 'revolver-1_01', ssg: 'ssg08-1', scar: 'scar20_01', g3: 'g3sg1_01' };
const FIRE_FAR = { usp: 'usp1-distant', glock: 'usp1-distant', duals: 'usp1-distant', deagle: 'deagle-1-distant', r8: 'revolver-1_distant', ssg: 'ssg08-1-distant', scar: 'scar20_distant_01', g3: 'g3sg1-1-distant' };
const CLIPOUT = { usp: 'usp_clipout', glock: 'usp_clipout', duals: 'usp_clipout', deagle: 'de_clipout', r8: 'revolver_prepare', ssg: 'ssg08_clipout', scar: 'g3sg1_clipout', g3: 'g3sg1_clipout' };
const CLIPIN = { usp: 'usp_clipin', glock: 'usp_clipin', duals: 'usp_clipin', deagle: 'de_clipin', r8: 'revolver_prepare', ssg: 'ssg08_clipin', scar: 'g3sg1_clipin', g3: 'g3sg1_clipin' };
const SLIDE = { usp: 'usp_sliderelease', glock: 'usp_sliderelease', duals: 'usp_sliderelease', deagle: 'de_slideforward', ssg: 'ssg08_boltforward', scar: 'g3sg1_slideforward', g3: 'g3sg1_slideforward' };
const DRAW = { ssg: 'ssg08_draw', g3: 'g3sg1_draw', scar: 'g3sg1_draw', r8: 'revolver_draw' };
...
export function sfxDraw(a) { if (isLocal(a)) play(DRAW[a.cur] ? w(DRAW[a.cur]) : 'equip', 0.5); }
...
export function sfxHitmarker(headshot, hadArmor) {   // only the local shooter hears their hitmarker
  play(headshot ? (hadArmor ? 'armor_headshot_hitmarker' : 'noarmor_headshot_hitmarker') : 'hitmarker', 0.6);
}
