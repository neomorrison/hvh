...
- **Anti-aim that does something.** Six yaw modes (back · sideways · spin · jitter · sway · rand) with a jitter/sway range that drives the body, a desync angle that is now real geometry (0° is genuinely no fake; 58° swings it about a body's width off you), **freestanding** — which looks at the map and puts the fake where the nearest enemy can see it, leaving the real you behind the corner — and **fake duck**, which holds you *really* ducked while the model keeps standing — your hitboxes sit a stance-height below whatever anyone is aiming at — bought with the ability to stand up and most of your speed. It needs neither desync nor a desync angle: the sideways fake and the vertical one are separate tricks.  A faster yaw, a wider desync, a fake pitch and a fake duck each cost a resolver something.
